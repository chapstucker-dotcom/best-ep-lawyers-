...
const faqs = [
  ...
  {
    question:
      "What types of cases do El Paso personal injury attorneys handle?",
    answer:
  ...
  {
    question:
      "What should I look for when comparing personal injury attorneys?",
    answer:
...
const personalInjuryDirectoryPage: PracticeAreaPageData = {
  path: "/el-paso-personal-injury-lawyers",
  shortTitle: "Personal Injury",
  title: "Best Personal Injury Lawyers in El Paso, TX",

  description:
    "Compare El Paso personal injury law firms handling car accidents, truck crashes, motorcycle accidents, slip and falls, dog bites, wrongful death, and insurance disputes.",

  metaDescription:
    "Compare personal injury lawyers in El Paso, Texas for accidents, serious injuries, wrongful death, and insurance disputes.",

  heroText:
    "Compare El Paso personal injury attorneys and law firms by practice focus, experience, and contact information.",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-7 max-w-3xl text-lg leading-8 text-slate-300 md:text-xl">
              Compare El Paso personal injury lawyers for car accidents,
              truck crashes, motorcycle wrecks, slip and falls, dog bites,
              serious injuries, wrongful death, and insurance disputes.
              Explore local legal resources and find attorneys who handle
              the type of injury claim you are facing.
            </p>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.35fr_.65fr]">
          <article>
            ...
            <p className="mt-5 text-lg leading-8 text-slate-300">
              An unexpected injury can create medical bills, time away
              from work, insurance questions, and uncertainty about who is
              responsible. Personal injury law generally addresses
              situations in which a person claims to have been harmed
              because of another person or company&apos;s negligence or
              wrongful conduct.
            </p>

            <p className="mt-5 text-lg leading-8 text-slate-300">
              El Paso personal injury attorneys may investigate how an
              accident occurred, preserve evidence, communicate with
              insurance companies, document damages, evaluate potential
              defendants, and advise clients about settlement or
              litigation. The specific work required depends on the facts
              of each case.
            </p>

            <p className="mt-5 text-lg leading-8 text-slate-300">
              El Paso&apos;s Best Lawyers is a local attorney directory. We
              help people compare lawyers by practice area; we are not a law
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 leading-7 text-slate-300">
              Personal injury is a broad practice area. These focused pages
              can help you compare attorneys for a specific type of accident
              or claim.
            </p>
          </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-slate-800 p-7">
            ...
            <p className="mt-3 leading-7 text-slate-300">
              ...
              insurance documents, vehicle evidence, property conditions,
              or other materials relevant to responsibility.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-800 p-7">
            ...
            <p className="mt-3 leading-7 text-slate-300">
              Some claims involve more than one potentially responsible
              party, such as drivers, employers, property owners,
              contractors, product manufacturers, or commercial businesses.
            </p>
          </div>
      ...
      >
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <h2 className="mt-3 text-3xl font-bold">
            El Paso Personal Injury Lawyers & Law Firms
          </h2>

          <p className="mt-4 max-w-3xl leading-7 text-slate-300">
            Compare listed El Paso firms that identify personal injury as
            an area of practice. Review firm information, practice focus,
            attorneys, and contact details before deciding whom to contact.
          </p>

          <div className="mt-8">
            <PracticeAreaFirmDirectory
              page={personalInjuryDirectoryPage}
            />
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-[.8fr_1.2fr]">
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-300">
                ...
                information can be used to help connect you with an
                appropriate participating attorney or firm.
              </p>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
          <h2 className="text-xl font-bold">
            Related El Paso Legal Resources
          </h2>
        ...
        <p className="mt-8 text-sm leading-6 text-slate-500">
          El Paso&apos;s Best Lawyers is an attorney directory and is not a
          law firm. Information on this page is general and is not legal
          advice. Attorney listings and directory placement do not guarantee
